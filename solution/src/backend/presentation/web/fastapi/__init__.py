...
from backend.application.exception.base import ApplicationError, CustomValidationError
...
from backend.presentation.web.fastapi.exc_handler import (
    ...
    missing_lon_or_lat_error_handler,
...
from backend.presentation.web.fastapi.transactions import transactions_router
...
def include_exception_handlers(app: FastAPI) -> None:
    ...
    app.add_exception_handler(CustomValidationError, custom_validation_error_handler)  # type: ignore
    app.add_exception_handler(MissingLonOrLatError, missing_lon_or_lat_error_handler)  # type: ignore
